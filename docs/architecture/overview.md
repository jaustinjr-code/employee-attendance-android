...
| `statusupdate` | the Status Update policy, foreground tracking, its notification and launch-intent contract, completed updates | `StatusUpdateCoordinator`, `AppForegroundTracker`, `StatusUpdateNotifier`, `StatusUpdateIntents`, `StatusUpdateRepository`, `StatusUpdateTrigger`, `StatusUpdateRequest`, `StatusUpdate`, `StatusUpdateQuestion` |
