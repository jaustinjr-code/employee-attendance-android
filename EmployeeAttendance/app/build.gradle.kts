...
android {
    namespace = "com.jaustinjr.employeeattendance"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.jaustinjr.employeeattendance"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    compileOptions {
        ...
        // java.time on minSdk 24; reporting does all of its calendar math with it.
    ...
    testOptions {
        unitTests {
            // Let android.util.Log and other framework stubs return defaults instead of throwing,
